      ...
      <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <div>
          <label
            ...
            >笔记标题 <span class="text-danger">*</span></label
          >
          <input
            type="text"
            id="noteTitle0"
        ...
        <div>
          <label
            for="noteCategory"
            class="block text-sm font-medium text-neutral-700 mb-1"
            >所属课程<span class="text-danger">*</span></label
          >
          <select
            id="noteCategory"
            name="noteCategory"
          ...
          <div class="relative">
            <i
              class="fa fa-chevron-down absolute right-4 top-[-35px] text-neutral-400 pointer-events-none"
            ></i>
          </div>
        </div>
        <!-- 标签输入 -->
        ...
        <div>
          ...
          >
            ...
            <p v-if="fileError" class="mt-2 text-sm text-danger">
              {{ fileError }}
            </p>
          </div>
          <div v-if="uploadedFiles.length">
            ...
            <div class="flex flex-wrap gap-2 mt-1">
              ...
              >
                ...
                <button
                  type="button"
                  class="ml-2 text-neutral-500 hover:text-danger transition-custom"
